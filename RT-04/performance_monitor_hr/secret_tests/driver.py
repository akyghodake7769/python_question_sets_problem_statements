...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Performance Monitor (HR-Style)\n")
    ...
    # Standardized TC Names for RT-04 Performance Monitor
    TC_NAMES = [
        "CPU Usage Metrics",
        "Memory Allocation Tracker",
        "I/O Wait Analysis",
        "Process Lifecycle Events",
        "Alert Triggering - Basic",
        "Rolling Average Calculation",
        "Peak Usage Identification",
        "Resource Leak Detection",
        "Multi-Process Comparison",
        "Sampling Interval Validation",
        "Data Logging - JSON Format",
        "Historical Trend Analysis",
        "Volume Test - 5000 Samples",
        "Real-time Update Frequency",
        "Max Resource Constraint Test"
    ]
