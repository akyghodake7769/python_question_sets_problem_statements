...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Fixed Size Warehouse (HR-Style)\n")
    ...
    # Standardized TC Names for RT2-07 Fixed Size Warehouse
    TC_NAMES = [
        "Sample Case 0 - Limit 3",
        "Sample Case 1 - Limit Change",
        "Instance Tracking Validation",
        "Custom Exception Message",
        "Deletion & Reuse Space",
        "Multiple Product Types",
        "Dynamic Limit Increase",
        "Limit at Max Capacity",
        "Invalid Product Cleanup",
        "Object Lifecycle Check",
        "Volume Test - 20 Ops",
        "Volume Test - 50 Ops",
        "Random Sequence - Low Limit",
        "Random Sequence - High Limit",
        "Max Constraint Warehouse"
    ]
