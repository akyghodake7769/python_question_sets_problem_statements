...
# Standardized Local Driver for Q-237: vectorized_portfolio_analytics_engine
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "vectorized_portfolio_analytics_engine"
    ...
    print(f"Running Local Evaluation for: Vectorized Portfolio Analytics Engine\n")
