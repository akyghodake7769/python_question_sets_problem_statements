# AF_Q06_E: Airflow DAG SLA Alerts
...
## Task Objectives
1. **Setup requirements**: Define SLA alerts on long-running tasks.
...
## Grading Criteria
- **TC1: SLA parameter check** (4 Marks)
- **TC2: Task association verify** (4 Marks)
- **TC3: DAG compilation check** (4 Marks)
