...
# Standardized Local Driver for Q-240: regex_based_log_forensic_engine
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "regex_based_log_forensic_engine"
    ...
    print(f"Running Local Evaluation for: Regex Based Log Forensic Engine\n")
