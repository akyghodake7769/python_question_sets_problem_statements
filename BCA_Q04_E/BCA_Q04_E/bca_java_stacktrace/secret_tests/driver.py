...
def run_tests():
    ...
    exc = data.get('exception_name', '').strip()
    ln = int(data.get('line_number', 0))
    results['tc1'] = True
    results['tc2'] = ('NullPointerException' in exc)
    results['tc3'] = (ln == 142)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '--json':
        ...
        TC_NAMES = {
            ...
            "tc2": "Exception name matches NullPointerException",
            "tc3": "Line number matches exactly line 142"
        }
        print("Running Auto-Evaluation for: Basic Code Analysis: Java Exception Stack Trace Triage\n")
        total_score = 0
