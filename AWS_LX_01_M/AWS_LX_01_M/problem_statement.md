...
- **Instance Name:** `<your-labskraft-username>-AWS-LX-01-M` (replace `<your-labskraft-username>` with your actual LabsKraft username, e.g. `labs-kraft-demo106-AWS-LX-01-M`)
...
| --------- | ------------------------------------------------------------------------------------ | ------- |
| **TC1**   | EC2 Instance Existence (`t2.micro`, Ubuntu, named `<username>-AWS-LX-01-M`)           | 5 Marks |
...
- Ensure the instance name is exactly `<your-labskraft-username>-AWS-LX-01-M`.
