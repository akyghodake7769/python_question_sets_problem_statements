# Linux File System & Directory Navigation

# Duration : 60 Min.

## Scenario

As a junior cloud administrator, you need to set up a specific directory hierarchy for an application on a newly provisioned AWS EC2 instance. This involves utilizing Linux directory navigation commands and file operations.
...
Log in to the EC2 instance via SSH and perform the following operations:
