...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Event Stream Processor (HR-Style)\n")
    ...
    # Standardized TC Names for RT-03 Event Stream Processor
    TC_NAMES = [
        "Basic Event Filtering",
        "Aggregation - Sum Over Window",
        "Aggregation - Average Over Window",
        "Event Deduplication",
        "Stream Sorting - Timestamp",
        "Anomaly Detection - Threshold",
        "Missing Data Handling",
        "Out of Order Events",
        "Multiple Stream Merge",
        "Event Pattern Matching",
        "Window Edge Case - Empty",
        "Window Edge Case - Single Item",
        "Volume Test - 1000 Events",
        "High Throughput Processing",
        "Max Constraint Stress Test"
    ]
    ...
    for i, in_file in enumerate(test_files):
        ...
        if not success:
            ...
            if i == 0 or total_score == 0:
                print(f"\n[RUNTIME/COMPILATION ERROR in TC{i+1}]:\n{actual}\n")
