...
def verify_task():
    ...
    # ==========================================
    # TC1: Directory Existence (4 points)
    # ==========================================
    ...
    # ==========================================
    # TC2: Notebook Existence (4 points)
    # ==========================================
    ...
    # ==========================================
    # TC3: Object Type Verification (4 points)
    # ==========================================
    ...
    # ==========================================
    # TC4: Notebook Language Verification (4 points)
    # ==========================================
    ...
    # ==========================================
    # TC5: Interactive Code Check (4 points)
    # ==========================================
