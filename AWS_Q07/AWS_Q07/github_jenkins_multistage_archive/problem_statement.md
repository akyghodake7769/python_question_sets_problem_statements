...
| ------------- | -------------------------------------- | --------------------------------------------------------- | -------- |
| **TC1** | **GitHub Webhook & Pipeline Job**| Webhook configured correctly & Pipeline job triggers      | 10 Marks |
| **TC2** | **Multi-Stage Execution Check**  | `Lint` & `Build` stages execute successfully              | 10 Marks |
| **TC3** | **Artifact Archiving Check**     | `build-artifact.txt` successfully archived in Jenkins     | 10 Marks |
