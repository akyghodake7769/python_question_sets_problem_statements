# AF_Q04_E: Airflow BashOperator PWD
...
## Task Objectives
1. **Setup requirements**: Deploy BashOperators logging workspace folders.
...
## Grading Criteria
- **TC1: DAG load confirm** (4 Marks)
- **TC2: Operator type confirmation** (4 Marks)
- **TC3: Command verification** (4 Marks)
