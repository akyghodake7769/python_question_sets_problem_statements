...
# Standardized Local Driver for Q-239: composition_based_data_analytics_hub
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "composition_based_data_analytics_hub"
    ...
    print(f"Running Local Evaluation for: Composition Based Data Analytics Hub\n")
