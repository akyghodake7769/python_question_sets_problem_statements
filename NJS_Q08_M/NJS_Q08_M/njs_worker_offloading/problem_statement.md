...
| --------- | ----------- | ----- |
| **TC1** | File server.js exists in workspace | 2.5 Marks |
| **TC2** | File worker.js exists in workspace | 2.5 Marks |
| **TC3** | Worker pools utilized for processing CPU-intensive operations | 2.5 Marks |
| **TC4** | Main execution threads remain non-blocked during hashing execution | 2.5 Marks |
| **TC5** | Asynchronous response payloads correctly formatted | 2.5 Marks |
| **TC6** | Worker data pbkdf2 properties configurations matched | 2.5 Marks |
| **TC7** | System handles thread messaging error events | 2.5 Marks |
| **TC8** | Node.js worker_threads module integrated successfully | 2.5 Marks |
