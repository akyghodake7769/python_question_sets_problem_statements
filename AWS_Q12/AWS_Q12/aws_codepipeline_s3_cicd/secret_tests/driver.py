    ...
    try:
        ...
        try:
            ...
            if tc1_passed:
                ...
                print(f"     └─ [Reason]: S3 bucket static website hosting not enabled or repo missing.")
        ...
        if not results.get('tc1'):
            ...
            try:
                ...
                if tc2_passed:
                    ...
                    results['tc2'] = False
                    print(f"TC2: AWS CodePipeline Configuration .................... [FAILED] (0/10)")
                    print(f"     └─ [Reason]: CodePipeline missing Source or S3 Deploy stages.")
            except Exception as e:
                results['tc2'] = False
                print(f"TC2: AWS CodePipeline Configuration .................... [FAILED] (0/10)")
                print(f"     └─ [Error]: {str(e)}")
            ...
            try:
                ...
                if tc3_passed:
                    ...
                    results['tc3'] = False
                    print(f"TC3: Pipeline Execution & Deployment ................... [FAILED] (0/10)")
                    print(f"     └─ [Reason]: Pipeline execution failed or index.html missing in S3 bucket.")
            except Exception as e:
                results['tc3'] = False
                print(f"TC3: Pipeline Execution & Deployment ................... [FAILED] (0/10)")
                print(f"     └─ [Error]: {str(e)}")
