...
| ------------- | ----------------------------------------- | -------------------------------------------------------- | -------- |
| **TC1** | **Repository & S3 Hosting Setup**   | Repo exists & S3 bucket configured for static hosting    | 10 Marks |
| **TC2** | **AWS CodePipeline Configuration**  | CodePipeline exists connecting Source to S3 Deploy stage | 10 Marks |
| **TC3** | **Pipeline Execution & Deployment** | Pipeline execution succeeded & index.html exists in S3   | 10 Marks |
