...
| **TC2** | File appsettings.json exists in workspace | 5 Marks |
| **TC3** | Health check path is configured to /healthz | 5 Marks |
| **TC4** | TimeoutSeconds parameter is set to 5 | 5 Marks |
