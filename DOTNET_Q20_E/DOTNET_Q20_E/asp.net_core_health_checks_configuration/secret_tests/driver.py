...
def run_tests():
    ...
    try:
        ...
        if hc.get("Path") == "/healthz":
            results['tc3'] = True
        if int(hc.get("TimeoutSeconds", 0)) == 5:
            results['tc4'] = True
    except Exception:
        pass
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '--json':
        ...
        TC_NAMES = {
            ...
            "tc2": "File appsettings.json exists in workspace", "tc3": "Health check path is configured to /healthz", "tc4": "TimeoutSeconds parameter is set to 5"
        }
