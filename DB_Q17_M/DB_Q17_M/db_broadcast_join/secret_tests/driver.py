...
def verify_task():
    ...
    tc_names = ['Join outcome correctness', 'Broadcast hint check in AST', 'Optimization execution check', 'Query plan metrics validation', 'Output schema structure check']
