...
# Standardized Local Driver for Q-234: resilient_event_dispatcher_system
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "resilient_event_dispatcher_system"
    ...
    print(f"Running Local Evaluation for: Resilient Event Dispatcher System\n")
