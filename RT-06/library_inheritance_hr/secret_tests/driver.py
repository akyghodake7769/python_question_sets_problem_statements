...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Library Inheritance (HR-Style)\n")
    ...
    # Standardized TC Names for RT-06 Library Inheritance
    TC_NAMES = [
        "Class Hierarchy - Basic",
        ...
        "Volume Test - 100 Instances",
        "Nested Object Hierarchy",
        "Max Constraint Memory Test"
    ]
