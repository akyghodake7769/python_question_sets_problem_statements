...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: DB Context (HR-Style)\n")
    ...
    # Standardized TC Names for RT2-06 DB Context
    TC_NAMES = [
        "Sample Case 0 - Robin",
        "Sample Case 1 - Sam",
        "Short Username (1 char)",
        "Long Username (100 chars)",
        "Numeric Username Check",
        "Special Chars Check",
        "Mixed Case Username",
        "Space in Username",
        "Multiple Entry/Exit",
        "Error handling inside context",
        "Volume Test - Concurrent simulate",
        "Large username stress test",
        "Random Username 1",
        "Random Username 2",
        "Max Load Connection Test"
    ]
