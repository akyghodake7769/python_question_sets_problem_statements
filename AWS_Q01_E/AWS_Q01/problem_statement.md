...
- **Bucket Name:** `labskraft-assessment-bucket-<your-labskraft-username>` (replace `<your-labskraft-username>` with your actual LabsKraft username, e.g. `labs-kraft-demo106`)
...
| ------------- | ----------------------------------------------------- | ------- |
| **TC1** | Bucket Existence (`labskraft-assessment-bucket-<username>`) | 5 Marks |
...
- Ensure the bucket name is exactly `labskraft-assessment-bucket-<your-labskraft-username>`.
