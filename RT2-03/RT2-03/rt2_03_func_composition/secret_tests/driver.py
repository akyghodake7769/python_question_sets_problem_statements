...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Function Composition (HR-Style)\n")
    ...
    # Standardized TC Names for RT2-03 Function Composition
    TC_NAMES = [
        "Sample Case 0 - Add/Split/Max",
        "Sample Case 1 - Add/Square/Split",
        "Add then Square Chain",
        "Split then Min Chain",
        "Multiple Arguments Add",
        "Deep Composition (5+ funcs)",
        "Single Function Composition",
        "Identity (Add) only",
        "Split/Max Interleaved",
        "Large Arguments Values",
        "Volume Test - 5 Queries",
        "Volume Test - 10 Queries",
        "Random Composition 1",
        "Random Composition 2",
        "Extreme Value Composition"
    ]
