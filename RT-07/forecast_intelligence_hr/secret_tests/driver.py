...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Forecast Intelligence (HR-Style)\n")
    ...
    # Standardized TC Names for RT-07 Forecast Intelligence
    TC_NAMES = [
        ...
        "Future Projections - 30 Days",
        "Missing Data Interpolation",
        "Confidence Interval Range",
        "Volume Test - Time Series",
        "Complex Multivariate Predict",
        "Max Constraint Algorithm Test"
    ]
