...
# Standardized Local Driver for Q-227: automatic_retry_manager
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "automatic_retry_manager"
    ...
    print(f"Running Local Evaluation for: Automatic Retry Manager\n")
