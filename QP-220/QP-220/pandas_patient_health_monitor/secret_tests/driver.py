...
# UPDATE 1: Added exam_code to the function signature
def test_student_code(solution_path, exam_code="UNKNOWN"):
    ...
    # UPDATE 2: Add Exam Code to the local report lines
    report_lines.append(f"EXAM CODE: {exam_code}\n")
...
if __name__ == "__main__":
    ...
    # UPDATE 3: Allow execution to accept an exam code argument (optional)
    arg_exam_code = sys.argv[2] if len(sys.argv) > 2 else "UNKNOWN"
    
    test_student_code(sol_file, exam_code=arg_exam_code)
