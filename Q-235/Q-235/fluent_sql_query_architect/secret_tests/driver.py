...
# Standardized Local Driver for Q-235: fluent_sql_query_architect
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "fluent_sql_query_architect"
    ...
    print(f"Running Local Evaluation for: Fluent Sql Query Architect\n")
