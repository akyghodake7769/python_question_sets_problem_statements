...
## Scenario
CI/CD execution pipelines require locking down the exact target .NET SDK tool version.
...
| **TC2** | File global.json exists in workspace root | 5 Marks |
| **TC3** | SDK version is configured to 8.0.100 | 5 Marks |
| **TC4** | rollForward logic is set to latestPatch | 5 Marks |
