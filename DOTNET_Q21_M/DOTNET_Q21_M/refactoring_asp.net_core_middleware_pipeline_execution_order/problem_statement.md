...
| **TC3** | UseAuthentication is registered before UseStaticFiles | 5 Marks |
| **TC4** | UseAuthorization is registered before UseStaticFiles | 5 Marks |
| **TC5** | Middleware pipeline order is correct and executes cleanly | 5 Marks |
