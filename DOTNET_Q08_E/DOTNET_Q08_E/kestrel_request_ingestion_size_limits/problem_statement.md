...
| **TC2** | File appsettings.json exists in the workspace | 5 Marks |
| **TC3** | MaxRequestBodySize is configured inside Kestrel Limits | 5 Marks |
| **TC4** | MaxRequestBodySize value matches 10485760 bytes | 5 Marks |
