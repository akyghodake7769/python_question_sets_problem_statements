...
def run_tests():
    ...
    if os.path.exists(props_path):
        ...
        try:
            ...
            if 'logging.level.org.springframework' in content:
                results['tc2'] = True
                
            if re.search(r'logging\.level\.org\.springframework\s*=\s*DEBUG', content):
                results['tc3'] = True
        except Exception:
            pass
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '--json':
        ...
        TC_NAMES = {
            ...
            "tc2": "logging level defined",
            "tc3": "logging level set to DEBUG"
        }
        total_score = 0
