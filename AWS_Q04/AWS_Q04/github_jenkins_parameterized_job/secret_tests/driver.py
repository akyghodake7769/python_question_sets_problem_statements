...
def verify_task():
    ...
    try:
        ...
        try:
            ...
            if tc1_passed:
                results['tc1'] = True
                print(f"TC1: GitHub Webhook Configuration & Auto-Trigger ....... [PASSED] (10/10)")
            else:
                results['tc1'] = False
                print(f"TC1: GitHub Webhook Configuration & Auto-Trigger ....... [FAILED] (0/10)")
        ...
        if not results.get('tc1'):
            results['tc2'] = False
            print(f"TC2: Jenkins Parameterized Job Configuration ........... [FAILED] (0/10)")
            print(f"     └─ [Reason]: Prerequisite failed (Webhook invalid).")
            results['tc3'] = False
            print(f"TC3: Successful Workspace Archive Creation ............. [FAILED] (0/10)")
            ...
            try:
                ...
                if tc2_passed:
                    results['tc2'] = True
                    print(f"TC2: Jenkins Parameterized Job Configuration ........... [PASSED] (10/10)")
                else:
                    results['tc2'] = False
                    print(f"TC2: Jenkins Parameterized Job Configuration ........... [FAILED] (0/10)")
            ...
            try:
                ...
                if tc3_passed:
                    results['tc3'] = True
                    print(f"TC3: Successful Workspace Archive Creation ............. [PASSED] (10/10)")
                else:
                    results['tc3'] = False
                    print(f"TC3: Successful Workspace Archive Creation ............. [FAILED] (0/10)")
                    print(f"     └─ [Reason]: backup archive not found in workspace in current session.")
            except Exception as e:
                results['tc3'] = False
                print(f"TC3: Successful Workspace Archive Creation ............. [FAILED] (0/10)")
                print(f"     └─ [Error]: {str(e)}")
