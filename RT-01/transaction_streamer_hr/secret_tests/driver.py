...
def test_student_code(solution_path=None):
    ...
    # Standardized TC Names for RT-01 Transaction Streamer
    TC_NAMES = [
        "Sample Trading Case",
        "Multiple Buy/Sell Cycles",
        "Strictly Decreasing (No Profit)",
        "Constant Prices (No Volatility)",
        "Strictly Increasing Trend",
        "Profit at Start - Dip at End",
        "Dip at Start - Profit at End",
        "High Volatility Random Walk",
        "Large Single Day Profit",
        "Small Incremental Gains",
        "Volume Stress Test (100)",
        "Volume Stress Test (500)",
        "Edge Case - First Day Sale",
        "Edge Case - Last Day Sale",
