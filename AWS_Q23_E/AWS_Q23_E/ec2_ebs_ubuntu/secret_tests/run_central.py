...
def main():
    ...
    print("\n🚀 Starting DevOps AWS EC2+EBS Ubuntu Central Evaluation...")
    ...
    try:
        with open(solution_path, 'r') as f:
            ...
            verify_aws_on_server(candidate_email, data.get('question_id', 'AWS_Q23_E'), labskraft_user, start_time, solution_data=data)
