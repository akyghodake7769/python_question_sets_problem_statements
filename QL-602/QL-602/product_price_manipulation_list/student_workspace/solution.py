...
class ProductManager:
    ...
    def calculate_total_revenue(self):
        ...
        Processing: Sum all prices in the list
        Output: Print: "Total Revenue: {total}"
        """
       """Your code here"""
    ...
    def apply_discount(self):
        ...
        Output: Print: "Discounted Prices: {list}"
        """
    ...
    def count_categories(self):
        ...
        Processing:
            ...
            - Premium: price >= 1000
        Output: Print: "Affordable Count: {count}, Premium Count: {count}"
        """
