...
# Standardized Local Driver for Q-232: high_throughput_lazy_data_streamer
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "high_throughput_lazy_data_streamer"
    ...
    print(f"Running Local Evaluation for: High Throughput Lazy Data Streamer\n")
