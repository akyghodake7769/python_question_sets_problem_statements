...
- **Zone:** `us-west1-a` (or as specified in your credentials sheet)
...
- **Region/Zone:** Deploy the instance in zone `us-west1-a` (or your pre-allocated zone).
...
| **TC2** | Virtual Machine existence (`vm-<prefix>` in zone `us-west1-a`) | 4 Marks |
