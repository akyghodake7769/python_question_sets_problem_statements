...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Priority Task Queue (HR-Style)\n")
    ...
    # Standardized TC Names for RT-02 Priority Task Queue
    TC_NAMES = [
        "Sample Operations - Add & Get",
        "Priority Based Selection",
        "Simple Dependency Chain",
        "Multiple Dependencies Resolution",
        "Complex Dependency Graph",
        "Get Status Cycle",
        "Ready Tasks List Sorting",
        "Task Completion Workflow",
        "Circular Dependency Handling",
        "Empty Queue Operations",
        "High Priority - No Deps",
        "Low Priority - Multiple Deps",
        "Volume Test - 100 Tasks",
        "Volume Test - Deep Deps",
