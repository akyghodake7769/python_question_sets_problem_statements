...
def verify_task():
    ...
    tc_names = ['Table existence verification', 'Override configuration check (invalidRetentionDurationCheck disable)', 'VACUUM execution check', 'Purged data files verification', 'Table history metadata retention check']
