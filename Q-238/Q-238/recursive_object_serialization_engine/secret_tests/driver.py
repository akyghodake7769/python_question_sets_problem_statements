...
# Standardized Local Driver for Q-238: recursive_object_serialization_engine
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "recursive_object_serialization_engine"
    ...
    print(f"Running Local Evaluation for: Recursive Object Serialization Engine\n")
