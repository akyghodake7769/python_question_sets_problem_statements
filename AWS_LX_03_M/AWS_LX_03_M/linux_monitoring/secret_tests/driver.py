...
def verify_task():
    ...
    # TC2: CPU/process monitoring snapshot output cpu_monitor.txt generated successfully
    tc2_passed = False
    if tc1_passed:
        out = run_ssm("test -s /home/ubuntu/cpu_monitor.txt && echo PASS || echo FAIL")
    ...
    # TC3: Memory monitoring snapshot output memory.txt generated successfully
    tc3_passed = False
    if tc1_passed:
        out = run_ssm("test -s /home/ubuntu/memory.txt && echo PASS || echo FAIL")
    ...
    # TC4: Disk diagnostics output disk.txt generated successfully
    tc4_passed = False
    if tc1_passed:
        out = run_ssm("test -s /home/ubuntu/disk.txt && echo PASS || echo FAIL")
    ...
    # TC5: Network diagnostics output network.txt generated successfully
    tc5_passed = False
    if tc1_passed:
        out = run_ssm("test -s /home/ubuntu/network.txt && echo PASS || echo FAIL")
