...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Banking Validation (HR-Style)\n")
    ...
    # Standardized TC Names for RT-05 Banking Validation
    TC_NAMES = [
        ...
        "Fraud Detection - High Volume",
        "Statement Date Range Check",
        "Overdraft Permission Logic",
        "Volume Test - Batch Process",
        "Concurrent Transaction Safety",
        "Max Constraint Stability"
    ]
