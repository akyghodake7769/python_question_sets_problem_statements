...
| **TC2** | **Docker Image Build Check**     | Docker image built successfully without syntax errors     | 10 Marks |
| **TC3** | **AWS ECR Image Push Check**     | Image successfully pushed & verified in AWS ECR registry  | 10 Marks |
