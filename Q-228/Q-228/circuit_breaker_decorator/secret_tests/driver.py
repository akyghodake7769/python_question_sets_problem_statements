...
# Standardized Local Driver for Q-228: circuit_breaker_decorator
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "circuit_breaker_decorator"
    ...
    print(f"Running Local Evaluation for: Circuit Breaker Decorator\n")
