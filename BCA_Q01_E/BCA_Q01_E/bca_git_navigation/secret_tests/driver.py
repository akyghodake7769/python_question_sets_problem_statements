...
#     results['tc1'] = True
#     results['tc2'] = (commit == '9b8f2d5' or commit == '9b8f2d5e')
...
#         print(f"[ERROR] Exception writing solution.json: {e}")
...
#             "tc2": "Correct commit hash identified",
#             "tc3": "Correct author username identified"
#         }
#         print("Running Auto-Evaluation for: Basic Code Analysis: Git History & Blame Navigation\n")
#         total_score = 0
