# AF_Q05_E: Airflow Pipeline Retries
...
## Task Objectives
1. **Setup requirements**: Configure retry rules and delays on tasks.
...
## Grading Criteria
- **TC1: Retries number confirm** (4 Marks)
- **TC2: Delay logic value check** (4 Marks)
- **TC3: Fail handler validation** (4 Marks)
