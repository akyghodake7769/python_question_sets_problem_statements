...
# Standardized Local Driver for Q-236: dependency_injection_lifecycle_container
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "dependency_injection_lifecycle_container"
    ...
    print(f"Running Local Evaluation for: Dependency Injection Lifecycle Container\n")
