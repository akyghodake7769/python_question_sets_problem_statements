...
def test_student_code(solution_path, vm_tag="DEFAULT"):
    slug = "Cpp_Track_Cloud_Server_Farm"
    ...
    try:
        ...
        if compile_res.returncode != 0:
            ...
            tc_configs = [
                {"desc": "TC1: Instantiate complex structures", "method": "testProvisionServer", "m": 0},
                {"desc": "TC2: Provision server with initial log", "method": "testProvisionServer", "m": 1},
                {"desc": "TC3: Allocate server with state check", "method": "testAllocateServer", "m": 2},
                {"desc": "TC4: Release server and accumulate usage", "method": "testReleaseServer", "m": 3},
                {"desc": "TC5: Retrieve full deployment trail", "method": "testGetServerHistory", "m": 1},
                {"desc": "TC6: Calculate total datacenter usage", "method": "testTotalDatacenterUsage", "m": 1},
                {"desc": "TC7: Perform bulk compute optimization", "method": "testOptimizeServers", "m": 2}
            ]
