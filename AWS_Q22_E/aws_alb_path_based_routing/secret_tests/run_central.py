...
def main():
    ...
    print("\n[SYSTEM] Starting DevOps ALB Path-Routing Central Evaluation...")
    ...
    try:
        with open(solution_path, 'r') as f:
            ...
            verify_aws_on_server(data.get('email', 'GUEST'), data.get('question_id', 'AWS_Q22_E'), labskraft_user, start_time, solution_data=data)
