...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Secure Login System (HR-Style)\n")
    ...
    # Standardized TC Names for RT2-02 Secure Login
    TC_NAMES = [
        "Sample Case 0 - All Success",
        "Sample Case 1 - Single Fail",
        ...
        "Volume Test - 10 Users",
        "Volume Test - 50 Attempts",
        "Random Sequence - Success Heavy",
        "Random Sequence - Fail Heavy",
        "Max Load Security Stress"
    ]
