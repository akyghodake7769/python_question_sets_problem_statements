...
# Standardized Local Driver for Q-241: runtime_validation_schema_engine
...
def test_student_code(solution_path=None, vm_tag="DEFAULT"):
    ...
    problem_code = "runtime_validation_schema_engine"
    ...
    print(f"Running Local Evaluation for: Runtime Validation Schema Engine\n")
