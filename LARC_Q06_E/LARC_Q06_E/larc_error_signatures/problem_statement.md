# Log Analysis: Error Signatures & Runbook Mapping
...
| **TC2** | Database connection pool timeout mapped to RB-102 | 4 Marks |
| **TC3** | Memory leak exception mapped to RB-205 | 3 Marks |
