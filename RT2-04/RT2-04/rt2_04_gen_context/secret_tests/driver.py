...
def test_student_code(solution_path=None):
    ...
    # Standardized TC Names for RT2-04 Generator Context
    TC_NAMES = [
        "Sample Case 0 - 6 terms",
        "Sample Case 1 - Single term",
        "Small Start & Step",
        "Large Start & Step",
        "Step equals Start",
        "Zero Num Requested",
        "Max Num Constraint (10)",
        "Consecutive Generator Calls",
        "Context Exit Validation",
        "Generator exhaustion check",
        "Volume Test - 20 terms",
        "Volume Test - 100 terms",
        "Random Sequence 1",
        "Random Sequence 2",
        "Extreme Range Sequence"
    ]
