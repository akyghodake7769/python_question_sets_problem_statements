...
def test_student_code(solution_path=None):
    ...
    print("Running Local Evaluation for: Generator Context (HR-Style)\n")
    ...
    # Standardized TC Names for RT2-04: Resettable Stateful Sequence
    TC_NAMES = [
        "Sample Case 0 - Reset Logic",
        "Sample Case 1 - Basic Continuation",
        "Sequence Consistency - Low Step",
        "Large Increments Check",
        "Multiple Batch Execution",
        "Zero Increment Scenario",
        "State Preservation Check",
        "Reset Persistence Validation",
        "Large Batch Volume Test",
        "Interleaved Reset & Generate",
        "Consecutive Generate Calls",
        "Lifecycle Message Check",
        "Boundary Value Generation",
        "Frequent Resets Stress",
        "Maximum Constraint Load"
    ]
