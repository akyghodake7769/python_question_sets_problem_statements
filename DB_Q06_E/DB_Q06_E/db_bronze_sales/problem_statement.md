# DB_Q06_E: Lakehouse Ingestion Layer
...
## Task Objectives
1. **Setup requirements**: Configure a bronze layer Delta table for raw sales ingestion.
...
## Grading Criteria
- **TC1: Delta table existence (bronze_sales)** (4 Marks)
- **TC2: Schema columns check** (4 Marks)
